...
<html>
  ...
  <body>
    ...
    <form action="sup_addSup.do" method="post" onsubmit="return checkFrm();">
      <table width="500" align="center" style="margin-top:30px" class="inputTable">
        <tr>
          <th>供应商编号：</th>
          <td><input class="text" name="supplier.supid" value="${supplier.supid}"/><my:errInfo key="supplierId"/></td>
        </tr>
        <tr>
          <th>供应商名称：</th>
