...
<html>
  ...
  <body>
    <my:navigation text="基础设置 >>　供应商类别管理 >> 修改类别" percent="90"/>
    <form action="supType_editType.do" method="post" onsubmit="return checkFrm();">
      <table width="500" align="center" style="margin-top:30px" class="inputTable">
        <tr>
          <th>供应商类别编号：</th>
          <td><input type="hidden" name="supType.suptypeid" value="${supType.suptypeid}"/>${supType.suptypeid}</td>
        </tr>
        <tr>
          <th>类别名称：</th>
