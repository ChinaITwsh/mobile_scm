...
<html>
  ...
  <body>
    ...
    <form action="cust_addCust.do" method="post" onsubmit="return checkFrm();">
      <table width="500" align="center" style="margin-top:30px" class="inputTable">
        <tr>
          <th>客户编号：</th>
          <td><input class="text" name="cust.custid" value="${cust.custid}"/><my:errInfo key="dupCustId"/></td>
        </tr>
        <tr>
          <th>客户名称：</th>
        ...
        <tr>
          <th>备注：</th>
          <td><textarea class="text" name="cust.remark" style="width:300px;height:46px"/>${cust.remark}</textarea></td>
        </tr>
